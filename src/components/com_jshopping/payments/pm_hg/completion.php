                    ...
                    $('#alfaclick_button').click(function () {
                        jQuery.post('<?= $alfaclick_url ?>',
                            ...
                            if (result.trim() == 'ok') {
                                ...
                                $('#hutkigrosh_message').remove();
                                $('#hutkigrosh_buttons').before('<div class="alert alert-error" id="hutkigrosh_message"><?= $translator->translate("hutkigrosh_alfaclick_msg_unsuccess") ?></div>');
                            }
                        })
                    })
                });
