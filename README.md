...
2. Загрузите архив с модулем [hg_joom_shopping_install.zip](https://github.com/esasby/hutkigrosh-joomla3-joomshopping4-module/blob/master/hg_joom_shopping_install.zip)
